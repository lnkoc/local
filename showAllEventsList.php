...
if($logged) {
  $sql2 = "SELECT WYDARZENIE_DANE.WYDARZENIE_ID, WYDARZENIE_DANE.NAZWA, WYDARZENIE_DANE.MIEJSCE, WYDARZENIE_DANE.DATA_START, WYDARZENIE_DANE.CZAS_START, ORGANIZATOR.IMIE, ORGANIZATOR.NAZWISKO, WYDARZENIE_DANE.DATA_STOP_REJESTRACJA, WYDARZENIE_DANE.CZAS_STOP_REJESTRACJA
