...
SELECT KLASA.NAZWA, UZYTKOWNIK.IMIE, UZYTKOWNIK.NAZWISKO, UZYTKOWNIK.ORGANIZACJA, UZYTKOWNIK.LICENCJA
FROM ORGANIZATOR, WYDARZENIE_DANE, WYDARZENIE_KLASA, KLASA, REJESTRACJA, UZYTKOWNIK
WHERE ORGANIZATOR.LOGIN = 'user'
...
SELECT WYDARZENIE_DANE.WYDARZENIE_ID, WYDARZENIE_DANE.NAZWA, WYDARZENIE_DANE.MIEJSCE, WYDARZENIE_DANE.DATA_START, WYDARZENIE_DANE.CZAS_START,
ORGANIZATOR.IMIE, ORGANIZATOR.NAZWISKO
